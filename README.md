...
7. Por ultimo, vamos rodar as migrações para deixar seu banco de dados no formato correto, digite no console `yarn typeorm migration:run` e todas as migrações devem ser rodadas e está tudo pronto para os testes.
